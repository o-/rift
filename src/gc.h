...
#ifdef GC_DEBUG
                assert(cur->canary[0] == Free::CANARY);
                assert(cur->canary[1] == Free::CANARY);
#endif
                if (cur->blocks > needed) {
...
#ifdef GC_DEBUG
        first->canary[0] = Free::CANARY;
        first->canary[1] = Free::CANARY;
#endif
...
#ifdef GC_DEBUG
        f->canary[0] = Free::CANARY;
        f->canary[1] = Free::CANARY;
#endif
    }
